...
class ChatVC: UIViewController, UITableViewDelegate, UITableViewDataSource {
    ...
    override func viewDidLoad() {
        super.viewDidLoad()
        //This is where the keyboard gets bound to the view using the UIVIew extension KeyboardBoundView
        view.bindToKeyboard()
        
        tableView.delegate = self
        tableView.dataSource = self
        
        //this allows out message cell to resize if message is very long
        ...
        SocketService.instance.getTypingUsers { (typingUsers) in
            ...
            for (typingUser, channel) in typingUsers {
                //Check we are not displaying our own name
                if typingUser != UserDataService.instance.name && channel == channelId {
                    //Add name to our name variable
                    if names == "" {
                        names = typingUser
                    } else {
